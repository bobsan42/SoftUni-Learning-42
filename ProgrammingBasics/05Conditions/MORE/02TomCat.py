...
tot = 365 * ptw + (pth - ptw) * hd
d = abs(tot - lim)
h = d // 60
m = d % 60
if tot > lim:
    line1 = 'Tom will run away'
    line2 = f'{h} hours and {m} minutes more for play'
else:
    line1 = 'Tom sleeps well'
    line2 = f'{h} hours and {m} minutes less for play'
print(line1)
print(line2)
